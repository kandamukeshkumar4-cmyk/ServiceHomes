      ...
      <form [formGroup]="form" (ngSubmit)="submit()" class="flex flex-column gap-3">
        <div class="surface-0 shadow-1 border-round-lg p-3">
          ...
          <div class="flex flex-column gap-2">
            <label>Title</label>
            <input class="p-inputtext" formControlName="title" placeholder="Cozy cabin in the woods" />
          </div>
          <div class="flex flex-column gap-2 mt-2">
            <label>Description</label>
            <textarea class="p-inputtext" formControlName="description" rows="4" placeholder="Describe your place..."></textarea>
          </div>
          <div class="flex flex-column gap-2 mt-2">
        ...
        <div class="surface-0 shadow-1 border-round-lg p-3">
          ...
          <div class="grid gap-2">
            <div class="col-6 flex flex-column gap-2">
              ...
              <input type="number" class="p-inputtext" formControlName="maxGuests" />
            </div>
            <div class="col-6 flex flex-column gap-2">
              <label>Bedrooms</label>
              <input type="number" class="p-inputtext" formControlName="bedrooms" />
            </div>
            <div class="col-6 flex flex-column gap-2">
              <label>Beds</label>
              <input type="number" class="p-inputtext" formControlName="beds" />
            </div>
            <div class="col-6 flex flex-column gap-2">
              <label>Bathrooms</label>
              <input type="number" class="p-inputtext" formControlName="bathrooms" />
            </div>
          </div>
        </div>
        ...
        <div class="surface-0 shadow-1 border-round-lg p-3">
          ...
          <div class="grid gap-2">
            <div class="col-4 flex flex-column gap-2">
              ...
              <input type="number" class="p-inputtext" formControlName="nightlyPrice" />
            </div>
            <div class="col-4 flex flex-column gap-2">
              <label>Cleaning fee</label>
              <input type="number" class="p-inputtext" formControlName="cleaningFee" />
            </div>
            <div class="col-4 flex flex-column gap-2">
              <label>Service fee</label>
              <input type="number" class="p-inputtext" formControlName="serviceFee" />
            </div>
          </div>
        </div>
        ...
        <div class="surface-0 shadow-1 border-round-lg p-3" formGroupName="location">
          ...
          <div class="flex flex-column gap-2">
            ...
            <input class="p-inputtext" formControlName="addressLine1" />
          </div>
          <div class="flex flex-column gap-2 mt-2">
            <label>Address line 2</label>
            <input class="p-inputtext" formControlName="addressLine2" />
          </div>
          <div class="grid gap-2 mt-2">
            <div class="col-6 flex flex-column gap-2">
              <label>City</label>
              <input class="p-inputtext" formControlName="city" />
            </div>
            <div class="col-6 flex flex-column gap-2">
              <label>State</label>
              <input class="p-inputtext" formControlName="state" />
            </div>
            <div class="col-6 flex flex-column gap-2">
              <label>Postal code</label>
              <input class="p-inputtext" formControlName="postalCode" />
            </div>
            <div class="col-6 flex flex-column gap-2">
              <label>Country</label>
              <input class="p-inputtext" formControlName="country" />
            </div>
          </div>
        </div>
        ...
        <div class="surface-0 shadow-1 border-round-lg p-3" formGroupName="policy">
          ...
          <div class="grid gap-2">
            <div class="col-6 flex flex-column gap-2">
              ...
              <input type="time" class="p-inputtext" formControlName="checkInTime" />
            </div>
            <div class="col-6 flex flex-column gap-2">
              <label>Check-out time</label>
              <input type="time" class="p-inputtext" formControlName="checkOutTime" />
            </div>
            <div class="col-6 flex flex-column gap-2">
              <label>Min nights</label>
              <input type="number" class="p-inputtext" formControlName="minNights" />
            </div>
            <div class="col-6 flex flex-column gap-2">
              <label>Max nights</label>
              <input type="number" class="p-inputtext" formControlName="maxNights" />
            </div>
            <div class="col-6 flex flex-column gap-2">
        ...
        <div class="surface-0 shadow-1 border-round-lg p-3">
          ...
          <div class="flex flex-wrap gap-2">
            <label *ngFor="let amenity of amenities" class="flex align-items-center gap-2 px-3 py-2 border-1 surface-border border-round-lg cursor-pointer hover:surface-100">
              <input type="checkbox" [value]="amenity.id" (change)="toggleAmenity(amenity.id, $event)" />
